...
class Index extends Component
{
    ...
    {
        return redirect()->route('admin.usuarios.alumnos.create');
    }

    public function edit($id)
    {
        return redirect()->route('admin.usuarios.alumnos.edit', [$id]);
    }
    ...
    public function deleteSubmit()
    {
        ...
        if (!Hash::check($this->password, Auth::user()->password)) {
            $this->notifications('danger', 'Alumnos', 'La contraseña no coincide con la actual.');
            return;
        }
        ...
        try {
            ...
            $this->reset(['delteId']);
            $this->notifications('danger', 'Alumnos', 'El alumno ha sido eliminado junto a sus registros');
        } catch (\Exception $e) {
            DB::rollBack();
            dd($e->getMessage());
    ...
    public function render()
    {
        ...
        $collection = $collection->where('type_user_id', 3);
        ...
        return view('livewire.modules.users.admin.alumno.index', [
