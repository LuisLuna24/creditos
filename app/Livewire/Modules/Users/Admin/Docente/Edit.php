...
class Edit extends Component
{
    ...
    public function mount()
    {
        ...
        $this->dataForm->searchDocente($this->id);
    ...
    public function validateData()
    {
        switch ($this->currentStep) {
            ...
            case 1:
                ...
                break;
            case 2:
                $this->dataForm->validateFormDocentes();
                break;
        }
    }
    ...
    public function submitForm()
    {
        ...
        try {
            ...
            $this->userForm->editUser();
            $this->dataForm->editDocente();

            DB::commit();
            $this->notifications('success', 'Docente', 'El docente se ha editado correctamente');
            $this->resetSteps();
            $this->dataForm->searchDocente($this->id);
            $this->userForm->searchUser($this->id);
        } catch (\Exception $e) {
    ...
    {
        return view('livewire.modules.users.admin.docente.edit');
    }
}
