...
class Create extends Component
{
    ...
    public function submitForm(){
        ...
        try{
            ...
            $this->dataForm->createDocente($this->userForm->userId);

            DB::commit();
            $this->notifications('success','Docente','El docente se ha agregado correctamente');
            $this->resetSteps();
    ...
    {
        return view('livewire.modules.users.admin.docente.create');
    }
}
