<div>
    <div
        ...
        <div>
            <h2 class="text-2xl font-bold text-gray-900 dark:text-white">Editar Taller</h2>
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Este apartado es para editar el taller</p>
        </div>
