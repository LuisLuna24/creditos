        ...
        <div class="overflow-x-auto border border-gray-200 dark:border-gray-700 rounded-lg">
            <x-table.table>
                ...
                <x-slot name="rows">
                    ...
                    @empty
                        <x-table.empty-state cols="4" message="No hay alumnos inscritos en este horario." />
                    @endforelse
                </x-slot>
            </x-table.table>
        </div>
        ...
        <x-slot name="content">
            ...
            <form wire:submit="liberarCreditos">
                ...
                <div class="flex justify-around mt-5">
                    <x-danger-button wire:click="$set('showConfirmModal',false)">Cancelar</x-danger-button>
                    <x-button>Liberar</x-button>
                </div>
            </form>
        </x-slot>
